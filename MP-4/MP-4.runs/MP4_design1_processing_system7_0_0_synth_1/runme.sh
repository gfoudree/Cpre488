...
HD_PWD='U:/Documents/MP-4/MP-4.runs/MP4_design1_processing_system7_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP4_design1_processing_system7_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP4_design1_processing_system7_0_0.tcl
