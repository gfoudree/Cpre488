...
HD_PWD='U:/Documents/MP-4/MP-4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP4_design1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP4_design1_wrapper.tcl -notrace
