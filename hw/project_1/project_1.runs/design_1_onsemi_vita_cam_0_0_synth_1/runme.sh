...
HD_PWD='U:/Desktop/MP-2/hw/project_1/project_1.runs/design_1_onsemi_vita_cam_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_onsemi_vita_cam_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_onsemi_vita_cam_0_0.tcl
