...
set rc [catch {
  ...
  set_property webtalk.parent_dir U:/Desktop/MP-2/hw/project_1/project_1.cache/wt [current_project]
  set_property parent.project_path U:/Desktop/MP-2/hw/project_1/project_1.xpr [current_project]
  set_property ip_repo_paths U:/Desktop/MP-2/hw/IP [current_project]
  set_property ip_output_repo U:/Desktop/MP-2/hw/project_1/project_1.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  set_property XPM_LIBRARIES {XPM_CDC XPM_FIFO XPM_MEMORY} [current_project]
  add_files -quiet U:/Desktop/MP-2/hw/project_1/project_1.runs/synth_1/design_1_wrapper.dcp
  set_msg_config -source 4 -id {BD 41-1661} -suppress
  set_param project.isImplRun true
  add_files U:/Desktop/MP-2/hw/design_1/design_1.bd
  set_property is_locked true [get_files U:/Desktop/MP-2/hw/design_1/design_1.bd]
  set_param project.isImplRun false
  read_xdc U:/Desktop/MP-2/hw/fmc_imageon_gs/zedboard_fmc_imageon_gs.xdc
  set_param project.isImplRun true
