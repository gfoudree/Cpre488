...
--Command     : generate_target MP0_design_1_wrapper.bd
...
entity MP0_design_1_wrapper is
  port (
...
end MP0_design_1_wrapper;

architecture STRUCTURE of MP0_design_1_wrapper is
  component MP0_design_1 is
  port (
    DDR_cas_n : inout STD_LOGIC;
    DDR_cke : inout STD_LOGIC;
    DDR_ck_n : inout STD_LOGIC;
  ...
  end component MP0_design_1;
begin
MP0_design_1_i: component MP0_design_1
     port map (
