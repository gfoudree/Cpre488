...
//		palette[i] = ((num >> 4) & 0x0f) | (((num & 0xf) << 4) | (num & 0xFF00));
...
void xil_init() {
	...
	*/
	 ...
	 XAxiVdma_WriteReg(XPAR_AXI_VDMA_0_BASEADDR, XAXIVDMA_MM2S_ADDR_OFFSET + XAXIVDMA_START_ADDR_OFFSET, VGA_frame);  // VDMA MM2S Start Addr 1
