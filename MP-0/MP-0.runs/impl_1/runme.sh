...
HD_PWD='C:/Users/njknuth/CPR_E_488_git/MP-0/MP-0.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_design_1_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source MP0_design_1_wrapper.tcl -notrace
