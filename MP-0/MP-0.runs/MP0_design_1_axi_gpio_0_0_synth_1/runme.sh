...
HD_PWD='U:/CPR E 488/MP-0/MP-0.runs/MP0_design_1_axi_gpio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_design_1_axi_gpio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP0_design_1_axi_gpio_0_0.tcl
