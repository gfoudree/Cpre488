...
HD_PWD='U:/CPR_E_488_git/MP-0/MP-0.runs/MP0_design_1_v_tc_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_design_1_v_tc_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP0_design_1_v_tc_0_0.tcl
