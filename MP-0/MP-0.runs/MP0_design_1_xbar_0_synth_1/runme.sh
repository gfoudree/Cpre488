...
HD_PWD='C:/Users/njknuth/CPR_E_488_git/MP-0/MP-0.runs/MP0_design_1_xbar_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log MP0_design_1_xbar_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source MP0_design_1_xbar_0.tcl
