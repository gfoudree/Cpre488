...
#
# Generated by export_simulation on Fri Jan 26 09:31:58 -0600 2018
#
################################################################################
...
switch to the './MP0_design_1.sh' script.

./MP0_design_1.sh -reset_run
...
./MP0_design_1.sh -noclean_files

For more information on the script, please type './MP0_design_1.sh -help'.
